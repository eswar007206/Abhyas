...
import { routeForRole, useAuth } from "@/lib/auth";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      <div className="hidden lg:flex relative overflow-hidden bg-black p-12 flex-col justify-between">
        ...
        <div className="relative space-y-6">
          ...
          <p className="max-w-md text-muted-foreground">
            Developer, organization admin, and student access all flow through Supabase Auth and
            role-based routing.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Organization students use credentials provided by their coaching center. Independent
              students can start free.
            </p>
          </div>
