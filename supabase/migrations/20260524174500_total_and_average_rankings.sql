-- Rank students by total raw marks and by average marks after 30 attempts.
-- Raw ranking rows store total marks in leaderboard_entries.score.
-- Average ranking rows store avg(score) in leaderboard_entries.average_score.
...
comment on function public.refresh_leaderboards_for_attempt(uuid) is
  'Refreshes aggregate leaderboard rows: total raw marks for raw scopes and average marks after 30 attempts for average scopes.';
